...
struct ICertificatePolicy_t793;
...
struct  ServicePointManager_t792  : public Object_t
{
};
struct ServicePointManager_t792_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t748 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t779 * ___server_cert_cb_9;
};
