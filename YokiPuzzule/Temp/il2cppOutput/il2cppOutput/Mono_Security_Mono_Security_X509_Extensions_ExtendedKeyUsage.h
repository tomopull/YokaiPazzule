...
struct  ExtendedKeyUsageExtension_t1094  : public X509Extension_t1005
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t232 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1094_StaticFields{
	...
	Dictionary_2_t50 * ___U3CU3Ef__switchU24map14_4;
};
