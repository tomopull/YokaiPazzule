...
struct  ExtendedKeyUsageExtension_t1015  : public X509Extension_t924
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t188 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1015_StaticFields{
	...
	Dictionary_2_t38 * ___U3CU3Ef__switchU24map14_4;
};
