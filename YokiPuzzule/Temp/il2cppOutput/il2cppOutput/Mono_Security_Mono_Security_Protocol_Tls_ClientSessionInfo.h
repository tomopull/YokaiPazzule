...
struct  ClientSessionInfo_t1037  : public Object_t
{
	...
	ByteU5BU5D_t581* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t581* ___masterSecret_5;
};
struct ClientSessionInfo_t1037_StaticFields{
