...
struct  X509Store_t823  : public Object_t
{
	...
	X509Certificate2Collection_t814 * ___list_2;
	...
	X509Store_t836 * ___store_4;
};
struct X509Store_t823_StaticFields{
	...
	Dictionary_2_t38 * ___U3CU3Ef__switchU24mapF_5;
};
