...
struct  X509Store_t905  : public Object_t
{
	...
	X509Certificate2Collection_t896 * ___list_2;
	...
	X509Store_t918 * ___store_4;
};
struct X509Store_t905_StaticFields{
	...
	Dictionary_2_t50 * ___U3CU3Ef__switchU24mapF_5;
};
